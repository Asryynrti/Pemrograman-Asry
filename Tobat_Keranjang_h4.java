...
public class Tobat_Keranjang_h4 extends JFrame {
    ...
    public Tobat_Keranjang_h4 () {
        this.getContentPane().setLayout (null);
        
        String sql = "SELECT * FROM projek.obat WHERE id_obat = 'oh004'";
    try {
	...
	jb2.addActionListener(new ActionListener(){
		public void actionPerformed(ActionEvent e){
			JOptionPane.showMessageDialog(Tobat_Keranjang_h4.this, "Pesanan sudah terdata. Silakan melakukan pembayaran di kasir. Terimakasih.");
			System.exit(0);
			}
		});
	...
	public static void main (String args[]) {
        Tobat_Keranjang_h4 t = new Tobat_Keranjang_h4();
    }
}